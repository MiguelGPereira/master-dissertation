		...
		Xmx="1000M") 
{
	...
	if(R.version$os=='mingw32') cp.sep<-'";"' else cp.sep<-'":"'
	classpath<-"-classpath /homes/up201402671/data/R/lib/carenR/exec"
	caren.command <- paste('/usr/lib/jvm/java-1.8.0-openjdk-1.8.0.151-1.b12.el6_9.x86_64/jre/bin/java',java.option,classpath,version.option, File,min.sup, min.conf,imp.option,
